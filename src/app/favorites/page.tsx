  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-secondary/20">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold font-headline mb-2">Your Favorites</h1>
          <p className="text-lg text-muted-foreground">All your cherished sessions in one place.</p>
        </div>
        ...
        {isLoaded && favoriteSessions.length === 0 && (
          <div className="flex flex-col items-center justify-center text-center py-20 border-2 border-dashed rounded-xl bg-card">
              ...
              <p className="text-muted-foreground mt-2">Add sessions to your favorites to see them here.</p>
