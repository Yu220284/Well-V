...
export default function TagsPage() {
  ...
  const AVAILABLE_TAGS = [
    { id: 'yoga', name: t('tags.yoga'), icon: Flower2, colorActive: 'bg-yellow-100 text-yellow-800 border-yellow-300', colorInactive: 'bg-yellow-50/30 text-yellow-900/60 border-yellow-200/40 hover:border-yellow-300/60' },
    { id: 'workout', name: t('tags.workout'), icon: Zap, colorActive: 'bg-pink-100 text-pink-800 border-pink-300', colorInactive: 'bg-pink-50/30 text-pink-900/60 border-pink-200/40 hover:border-pink-300/60' },
    { id: 'stretch', name: t('tags.stretch'), icon: StretchHorizontal, colorActive: 'bg-cyan-100 text-cyan-800 border-cyan-300', colorInactive: 'bg-cyan-50/30 text-cyan-900/60 border-cyan-200/40 hover:border-cyan-300/60' },
    { id: 'meditation', name: t('tags.meditation'), icon: Sparkles, colorActive: 'bg-green-100 text-green-800 border-green-300', colorInactive: 'bg-green-50/30 text-green-900/60 border-green-200/40 hover:border-green-300/60' },
  ];
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background to-secondary/20 p-3 relative">
      ...
      <Card className="w-full max-w-2xl relative z-10">
        <CardContent className="pt-6">
          ...
          <h1 className="text-xl font-bold text-center mb-1 mt-1">{t('onboarding.selectThemes')}</h1>
