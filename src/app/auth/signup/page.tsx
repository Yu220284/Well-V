        ...
        <CardContent>
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              ...
              <Button variant="outline" onClick={() => handleSocialSignup('microsoft')}>
                <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24">
              ...
              <Button variant="outline" onClick={() => handleSocialSignup('discord')}>
              ...
              <Button variant="outline" onClick={() => handleSocialSignup('instagram')}>
