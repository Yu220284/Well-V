...
export default function CommunityShopPage() {
  ...
  const trainer = TRAINERS.find(t => t.communityId === communityId);
        ...
        <div className="pt-24">
          <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="max-w-4xl mx-auto">
              <Link href={`/community?tab=${communityId}`} className="text-sm text-muted-foreground hover:text-primary mb-4 inline-flex items-center gap-1">
